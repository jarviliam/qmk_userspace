...
#if !defined(MIRYOKU_LAYER_GRAPH)
#    define MIRYOKU_LAYER_GRAPH MIRYOKU_ALTERNATIVES_BASE_GRAPHITE
#endif

#if !defined(MIRYOKU_LAYERMAPPING_GRAPH)
#    define MIRYOKU_LAYERMAPPING_GRAPH MIRYOKU_MAPPING
#endif
